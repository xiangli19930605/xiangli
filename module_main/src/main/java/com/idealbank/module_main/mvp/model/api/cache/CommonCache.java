...
public interface CommonCache {
    ...
    Observable<Reply<BaseResponse<List<ProjectClassifyData>>>> getGirlListCache(Observable<BaseResponse<List<ProjectClassifyData>>> users,  DynamicKey idLastUserQueried, EvictProvider evictProvider);
