...
import me.jessyan.armscomponent.commonsdk.base.MyBaseApplication;
...
public class FileUtils {
    public static final String APPS_ROOT_DIR = getExternalStorePath() + File.separator + MyBaseApplication.getApplication().getPackageName();
